...
<template>
    <Link :href="'/inicio'" class="flex space-x-2 w-full items-center group relative shrink-0 transition-all duration-500" >
        <div class="relative size-16 p-1 bg-white rounded-full flex items-center justify-center text-white overflow-hidden shadow-lg group-hover:scale-110 transition-transform duration-300">
            <!-- Icono -->
