            ...
            <div class="bg-slate-900 rounded-3xl p-8 md:p-16 relative overflow-hidden shadow-2xl shadow-[#2f4b59]/30">
                ...
                <div class="grid md:grid-cols-2 gap-12 relative z-10">
                    <div class="text-white">
                        ...
                        <!-- Botón WhatsApp -->
                        <a href="https://wa.me/1234567890" target="_blank" class="inline-flex items-center gap-3 bg-[#25D366] hover:bg-[#20bd5a] text-white px-6 py-3 rounded-xl transition-colors duration-300 font-bold mb-8 w-full md:w-auto justify-center">
                    ...
                    <div class="bg-white rounded-2xl p-6">
                        <n-form>
                            <n-form-item label="Nombre" path="name">
                                <n-input placeholder="Tu nombre" />
                            </n-form-item>
                            <n-form-item label="Email" path="email">
                                <n-input placeholder="ejemplo@correo.com" />
                            </n-form-item>
                            <n-form-item label="Mensaje" path="message">
                                <n-input type="textarea" placeholder="Cuéntanos tu idea..." />
                            </n-form-item>
                            <n-button type="primary" block color="#2f4b59" class="mt-2 h-10 font-bold">
                                Enviar Mensaje
                            </n-button>
                        </n-form>
                    </div>
